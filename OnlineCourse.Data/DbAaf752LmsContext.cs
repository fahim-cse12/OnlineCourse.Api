...
public partial class DbAaf752LmsContext : DbContext
{
    public DbAaf752LmsContext()
    {
    }

    public DbAaf752LmsContext(DbContextOptions<DbAaf752LmsContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Data Source=SQL6033.site4now.net;Initial Catalog=db_aaf752_lms;User Id=db_aaf752_lms_admin;Password=Bolbona@22");
